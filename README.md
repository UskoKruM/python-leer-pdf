# Leer archivos PDF con Python

Aprende a leer el contenido de un archivo PDF usando Python, usando la librería PyPDF2. Cónoce cómo extraer datos y leer los textos almacenados en un PDF usando Python.
